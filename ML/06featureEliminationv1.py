...
'''NAIVE BAYES''' #CANNOT USE RFECV?
#Generate the model
classifier = GaussianNB()

#Training the Naive Bayes model on the Training set to find the optimal number of features
rfecv_1 = RFECV(estimator = classifier, step=1, cv=5, scoring="roc_auc", importance_getter=callable)

#Train the dataset
rfecv_1 = rfecv_1.fit(x_train, y_train)
#classifier.fit(x_train, y_train) 

# Predicting the Test set results
#y_pred = classifier.predict(x_test)
y_pred = rfecv_1.predict(x_test)

#Metrics
print("NAIVE BAYES")
print("Optimal number of features:", rfecv_1.n_features_)
print("Best features:", x_train.columns[rfecv_1.support_])
...
#Training the LogReg model on the Training set to find the optimal number of features
rfecv_2 = RFECV(estimator = logreg, step=1, cv=5, scoring="roc_auc")

#Fit the model with data
rfecv_2 = rfecv_2.fit(x_train, y_train)
#classifier.fit(x_train, y_train)


#Predict the response for the dataset
y_pred=rfecv_2.predict(x_test)

#Metrics
print("LOGISTIC REGRESSION")
print("Optimal number of features:", rfecv_2.n_features_)
print("Best features:", x_train.columns[rfecv_2.support_])
print("Accuracy: ",metrics.accuracy_score(y_test, y_pred))
print(confusion_matrix(y_test, y_pred))
print(classification_report(y_test, y_pred))
print("AUROC score: ", roc_auc_score(y_test, y_pred))
...
#Training the KNN model on the Training set to find the optimal number of features
rfecv_3 = RFECV(estimator = knn, step=1, cv=5, scoring="roc_auc")

#Fit the model with data
#rfecv_3 = rfecv_3.fit(x_train_2, y_train)
knn.fit(x_train_2, y_train)

#Predict response for dataset
#y_pred = rfecv_3.predict(x_test_2)
y_pred = knn.predict(x_test_2)

#Metrics
print("K NEAREST NEIGHBORS")
#print("Optimal number of features:", rfecv_3.n_features_)
#print("Best features:", x_train.columns[rfecv_3.support_])
print("Accuracy: ",metrics.accuracy_score(y_test, y_pred))
print(confusion_matrix(y_test, y_pred))
print(classification_report(y_test, y_pred))
print("AUROC score: ", roc_auc_score(y_test, y_pred))
...
#Training the RF model on the Training set to find the optimal number of features
rfecv_4 = RFECV(estimator = rf, step=1, cv=5, scoring="roc_auc")
#rf.fit(x_train_rf, y_train)

#Fit the model with data
rfecv_4 = rfecv_4.fit(x_train_rf, y_train)

#Predict response for dataset
y_pred = rfecv_4.predict(x_test)

# Metrics
print("RANDOM FOREST")
print("Optimal number of features:", rfecv_4.n_features_)
print("Best features:", x_train.columns[rfecv_4.support_])
print("Accuracy: ",metrics.accuracy_score(y_test, y_pred))
print(confusion_matrix(y_test, y_pred))
print(classification_report(y_test, y_pred))
print("AUROC score: ", roc_auc_score(y_test, y_pred))
...
#Training the SVM model on the Training set to find the optimal number of features
rfecv_5 = RFECV(estimator = clf, step=1, cv=5, scoring="roc_auc")

#Fit the model with data
#clf.fit(x_train_svm, y_train)
rfecv_5 = rfecv_5.fit(x_train_svm, y_train)

#Predict the response for test dataset
y_pred = rfecv_5.predict(x_test_svm)


# Model Accuracy: how often is the classifier correct?
print("SVM: LINEAR KERNEL")
print("Optimal number of features:", rfecv_5.n_features_)
print("Best features:", x_train.columns[rfecv_5.support_])
print("Accuracy: ",metrics.accuracy_score(y_test, y_pred))
print(confusion_matrix(y_test, y_pred))
print(classification_report(y_test, y_pred))
print("AUROC score: ", roc_auc_score(y_test, y_pred))
