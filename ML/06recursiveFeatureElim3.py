...
#We will use an XGBoost model to evaluate the features during the recursive search
rfecv_model = xgb.XGBClassifier()
rfecv = RFECV(estimator = rfecv_model,step=5, cv=5, scoring="roc_auc")
#Optimal features = 9
